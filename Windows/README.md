...
```powershell
powershell -ExecutionPolicy Bypass -File .\publish-release.ps1 -Version 1.2.15
```

## Direct downloads

- [Latest x64 installer](https://github.com/agraja38/app-update-feeds/releases/download/justquit-windows-v1.2.15/justQuit-Setup-x64.exe)
- [Latest ARM64 installer](https://github.com/agraja38/app-update-feeds/releases/download/justquit-windows-v1.2.15/justQuit-Setup-ARM64.exe)
